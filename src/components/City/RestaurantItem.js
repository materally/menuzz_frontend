        ...
        <div className={"col-md-3 col-sm-6 mb-4 pb-2 " + styles.RestaurantItem}>
            <div className="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                <div className="list-card-image">
                    ...
                    {
                        (props.menu_url !== null && props.menu_url !== undefined && props.menu_url !== "") && <div className="member-plan position-absolute"><a href={props.menu_url} rel="noreferrer" target="_blank"><span className="badge badge-primary"><i className="fas fa-utensils"></i> MENÜ</span></a></div>
                    }
